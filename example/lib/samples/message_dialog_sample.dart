...
class MessageDialogSampleState extends State<MessageDialogSample> {
            ...
            SingleChildScrollView(
              ...
              child: Row(children: [
                ...
                Container(
                  ...
                  child: TextButton(
                      onPressed: () {
                        DialogManager.showYesNoDialog(context,
                            message: "Are you sure you are happy?",
                            clickedYes: () {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          checkButton(
                              showNegativeButton, "Show Negative Button", () {
                            setState(() {
                          ...
                          groupedCheckBox("Title Text Size", titleTextSize,
                              generateNumbers(start: 14, multiplier: 2),
                              (item) {
                            setState(() {
                              titleTextSize = double.parse(item.toString());
                            });
                          }),
                          groupedCheckBox("Message Text Size", messageTextSize,
                              generateNumbers(start: 14, multiplier: 2),
                              (item) {
                            setState(() {
                          ...
                          groupedCheckBox("Item Spacing", itemSpacing,
                              generateNumbers(start: 15, multiplier: 5),
                              (item) {
                            setState(() {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          groupedCheckBox("Curve Radius", dialogCurveRadius,
                              generateNumbers(start: 0, multiplier: 5), (item) {
                            setState(() {
                              dialogCurveRadius = double.parse(item.toString());
                            });
                          }),
                          groupedCheckBox("Elevation", dialogElevation,
                              generateNumbers(start: 0, multiplier: 5), (item) {
                            setState(() {
                          ...
                          groupedCheckBox("Margin", dialogMargin,
                              generateNumbers(start: 0, multiplier: 10),
                              (item) {
                            setState(() {
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          groupedCheckBox(
                              ...
                              ImageOrIconPlacement.values
                                  .indexOf(imageOrIconPlacement),
                              ["Normal", "Top"], (item) {
                            setState(() {
                              imageOrIconPlacement =
                                  ImageOrIconPlacement.values[item];
                            });
                          }, returnIndex: true),
                          groupedCheckBox("Image/Icon Size", imageOrIconSize,
                              generateNumbers(start: 20, multiplier: 10),
                              (item) {
                            setState(() {
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          groupedCheckBox(
                              "Fit",
                              DialogButtonFit.values.indexOf(dialogButtonFit),
                          ...
                          groupedCheckBox(
                              "Alignment",
                              DialogButtonAlignment.values
                                  .indexOf(dialogButtonAlignment),
                              ["Left", "Center", "Right"], (item) {
                            setState(() {
                              dialogButtonAlignment =
                                  DialogButtonAlignment.values[item];
                            });
                          }, returnIndex: true),
                          groupedCheckBox(
                              "Placement",
                              ButtonPlacement.values.indexOf(buttonPlacement),
                          ...
                          groupedCheckBox("Height", dialogButtonHeight,
                              generateNumbers(start: 35, multiplier: 5),
                              (item) {
                            setState(() {
                              dialogButtonHeight =
                                  double.parse(item.toString());
  ...
  Widget groupedCheckBox(String title, defaultValue, List items,
      Function(dynamic item) onItemSelected,
      ...
      children: [
        ...
        Wrap(
          children: List.generate(items.length, (index) {
            ...
            bool selected =
                (returnIndex ? items[defaultValue] : defaultValue) == item;
            return Container(
  ...
  List generateNumbers(
      {required int start, required int multiplier, int size = 6}) {
  ...
  void showMessageDialog({bool withImage = false}) {
    DialogManager.showMessageDialog(context,
        messageDialogModel: MessageDialogModel(
            title: "Welcome",
            message:
                "This is a sample message dialog and this is the little gift we have to offer",
            onPositiveClicked: () {
              showSnackBar("Clicked Yes");
            },
            onNegativeClicked: () {
